...
export default function Header(){
    return(
        <header className="bg-[#FF6900] font-serif">
            
            <div className="flex justify-between max-w-[1200px] mx-auto py-6 px-4">
                <img className="w-38 h-30" src="logo.png"></img>
                <div className="text-white text-base font-extrabold flex flex-wrap justify-end gap-8 items-center">
                    <a target="_blank ">QuickBite corporate</a>
                    <a target="_blank">Partner with us</a>
                    <a target="_blank" className="border border-white py-3 px-4 rounded-2xl">Get the App</a>
                    <a target="_blank" className="border border-black bg-black py-3 px-4 rounded-2xl">Sign in</a>
                </div>
            </div>
            ...
            <div className="pt-[64px] pb-[32px] relative">
                ...
                <div className="max-w-[90%] md:text-[48px] sm:text-[32px] xs:text-[24px] leading-tight text-white font-bold container mx-auto text-center max-w-[1200px]" >Order food & groceries. Discover best restaurants. QuickBite it!</div>
